...
### Fig 6a - Data
df_brut = pd.read_csv("./data/df_two_mimicry.csv")
...
### Fig 6b - Data and plotting
df = pd.read_csv("./data/df_two_mimicry_l1l2.csv")
...
### ### Fig 6c - Data and plotting
df = pd.read_csv("./data/df_two_mimicry_k1k2.csv")
